                    ...
                    <form method="POST" action="{{ route('journals.store') }}">
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="vente" name="vente" required>
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label for="productionVendue">Production Vendue:</label>
                                <input type="number" class="form-control" id="productionVendue" name="productionVendue" required>
                            </div>
                        </td>   
                        <div class="form-group">
